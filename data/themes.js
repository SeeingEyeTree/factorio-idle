...
const THEMES = {
    ...
    techs: {
      ...
      electricFurnaceTech        : { name: 'Vacuum Furnace'        , description: 'Upgrades all Furnaces → Electric. This will massivle incres your power draw. You were warned'                                                               , iconImg: 'data/icon_imgs/caffactory/electric_furnace.png' },
