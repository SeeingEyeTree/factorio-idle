...
const THEMES = {
  ...
  caffactory: {
    items: {
      ...
      rainbowScience:  { name: 'Caff-Infinite Limited Edition', img: 'data/icon_imgs/caffactory/caffactory_can_rainbow.png' },
      ...
      sulfur:          { name: 'Sour Powder',             img: 'data/icon_imgs/caffactory/sulfur.png' },
      ...
      nuclearReactorItem:  { name: 'Data Center',                img: 'data/icon_imgs/caffactory/data_center.png' },
    },
    ...
    techs: {
      ...
      logistics                  : { name: 'Process Optimization'       , description: 'Cuts building placement time by 0.25 seconds. Every second counts.' },
      ...
      radarTech                  : { name: 'Corporate Surveillance'     , description: 'Unlocks the Surveillance Tower for map exploration.'                                                     , iconImg: 'data/icon_imgs/caffactory/surveillance_tower.png' },
      electricMiningDrill        : { name: 'No Safety Mining'       , description: 'Unlocks the Automated Janitor (0.5/s, 90 kW, no coffee grounds required).'                             , iconImg: 'data/icon_imgs/caffactory/electric_mining_drill.png' },
      ...
      scriptingTech              : { name: 'Bring Your Own Laptop'      , description: 'Authorizes interns to write their own automation scripts.'                                              , iconImg: 'data/icon_imgs/caffactory/stylus.png' },
      concrete                   : { name: 'Cubicle Foundations'        , description: 'Unlocks Concrete for floor reinforcement.'                                                              , iconImg: 'data/icon_imgs/caffactory/concrete.png' },
      ...
      sulfurProcessing           : { name: 'Sulfur Processing'          , description: 'Extracts Sour Powder from the chemistry chain. Patent pending.'                                        , iconImg: 'data/icon_imgs/caffactory/sour_powder.png' },
      ...
      spidertron                 : { name: 'Executive Hover Chair'      , description: 'For C-suite use only. Pew pew.'                                                                         , iconImg: 'data/icon_imgs/caffactory/marketing_missile.png' },
      ...
      electricFurnaceTech        : { name: 'Vacuum Furnace'        , description: 'Unlocks the Industrial Espresso Machine.'                                                               , iconImg: 'data/icon_imgs/caffactory/espresso_machine.png' },
      ...
      speedModuleTech3           : { name: 'Nuclear Espresso Mk3'       , description: 'Pure adrenaline in a slot.'                                                                             , iconImg: 'data/icon_imgs/caffactory/triple_shot_3.png' },
      ...
      productionSciencePack      : { name: 'Overtime Approval'          , description: 'Unlocks the Caff-Infinite Overtime recipe.'                                                             , iconImg: 'data/icon_imgs/caffactory/caffactory_can_purple.png' },
      processingUnitTech         : { name: 'UM 300 Architecture'        , description: 'Unlocks the UM 300 — flagship Caff-Infinite chip, named for Urban Müller.'                            , iconImg: 'data/icon_imgs/caffactory/um_300.png' },
      automation3                : { name: 'Intern Onboarding 3'        , description: 'Unlocks the Senior Intern Pod. Glass walls, dual monitors, hope.'                                      , iconImg: 'data/icon_imgs/caffactory/intern_pod_3.png' },
      uraniumProcessing          : { name: 'Banned Substance Handling'  , description: 'OSHA-restricted ingredients now legal in three jurisdictions.'                                          , iconImg: 'data/icon_imgs/caffactory/banned_powder.png' },
      ...
      atomicBombTech             : { name: 'Limited Edition Drop'       , description: 'Marketing event of the decade. Casualties expected.'                                                    , iconImg: 'data/icon_imgs/caffactory/atomic_drink.png' },
      ...
      nuclearPowerTech           : { name: 'Data Center Operations'     , description: 'Unlocks the Data Center. Runs hot. Profitable.'                                                         , iconImg: 'data/icon_imgs/caffactory/data_center.png' },
      ...
      rainbowSciencePack         : { name: 'Limited Edition Run'        , description: "Unlocks the Caff-Infinite Limited Edition recipe. Iridescent. Probably a collector's item."            , iconImg: 'data/icon_imgs/caffactory/caffactory_can_rainbow.png' },
      utilitySciencePack         : { name: 'Happiness Recipe'           , description: 'Unlocks the Caff-Infinite Happiness recipe.'                                                            , iconImg: 'data/icon_imgs/caffactory/caffactory_can_yellow.png' },
    ...
    buildings: {
      ...
      nuclearReactor:{ name: 'Data Center' },
    },
